  ...
  final actions = [
    PopupMenuButton<String>(
        ...
        itemBuilder: (context) {
          ...
          return [
            ...
            if (showPasswordOption &&
                verificationMethod != kUsePermanentPassword)
              PopupMenuItem(
                value: "setCustomTemporaryPassword",
                child: Text(translate("Set custom one-time password")),
              ),
            if (showPasswordOption) const PopupMenuDivider(),
            if (showPasswordOption)
              PopupMenuItem(
        ...
        onSelected: (value) async {
          ...
          } else if (value == "setCustomTemporaryPassword") {
            String currentCustomPassword = await bind.mainGetOption(key: 'custom-temporary-password');
            setCustomTemporaryPasswordDialog(gFFI.dialogManager, currentCustomPassword, () async {
  ...
  dialogManager.showCustomDialog(
    ...
    actions: [
      dialogButton(
        translate("Cancel"),
        onPressed: () {
          dialogManager.dismissCustomDialog();
        },
        isOutline: true,
      ),
